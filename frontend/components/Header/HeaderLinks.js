...
export default function HeaderLinks(props) {
  ...
  const { noHome, noBlog } = props;
  
  const showHome = classNames({
    [classes.noShow]: noHome,
    [classes.listItem]: true,
  });

  const showBlog = classNames({
    [classes.noShow]: noBlog,
    [classes.listItem]: true,
  });

  return (
    <List className={classes.list}>
      <ListItem className={showHome}>
        <Link className={classes.navLink} href="/">
          <Button color="transparent">Home</Button>
        </Link>
      </ListItem>
      <ListItem className={showBlog}>
        <Link className={classes.navLink} href="/blog">
          <Button color="transparent">Blog & Releases</Button>
        </Link>
      </ListItem>
      <ListItem className={classes.listItem}>
        <Link
          className={classes.navLink}
          href="https://github.com/astaqc"
          target="_blank" 
        >
          <Button color="transparent">Code</Button>
        </Link>
      </ListItem>
      <ListItem className={classes.listItem}>
        <Link
